  ...
  <div class="wrap">
    <div class="container" id="homePage">
      ...
      <div class="row">
        ...
        <div class="col-md-7 text-center chatBubbleInstagram animated bounceInLeft">
        ...
        <div class="col-md-4 text-center chatBubbleTwitter animated bounceInRight">
